...
<div class="container mt-5">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editProductModal" onclick="populateEditModal(<%=product.getProductId()%>,<%=product.getName()%>,<%=product.getPrice()%>,<%=product.getDescription()%>,<%=product.getStockQuantity()%>,<%=product.getCategory().getName()%>);">Edit</button>
