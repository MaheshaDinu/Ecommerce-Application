...
<nav class="navbar navbar-expand-lg bg-light">
  <div class="container-fluid">
    <a class="navbar-brand fw-bold" href="#"><img src="../Assets/Images/UnishopZone%20Background%20removed.png" style="height: 5rem; width: 5rem" id="logo-img"> UniShopZone</a>
    <div class="collapse navbar-collapse">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item"><a class="nav-link" href="adminDashboard.jsp">Products</a></li>
        <li class="nav-item"><a class="nav-link active" href="adminCategoryManagement.jsp">Categories</a></li>
